# ST 517 - Module 3 Lab Reconn

# OpenIntro - Husband and Wife data; pg 341, 350, 351

# Save data for students ===========
# age <- read.table(url("http://stat511.cwick.co.nz/labs/husbandwife.txt"), sep = "\t", header = TRUE)
# write.csv(age, file = "Age.csv")

# Charlotte's Lab: http://stat511.cwick.co.nz/labs/lab-8.html

# Getting Started ============================
setwd("~/Desktop/ST 517/Week3/Lab")
